      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginBottom: 40 }}>
        {[
          ...
          <div key={s.label} style={{ border: '1px solid var(--faint)', padding: '20px 24px' }}>
            <p style={{ fontFamily: 'var(--font-mono)', fontSize: 8, letterSpacing: 3, textTransform: 'uppercase', color: 'var(--muted)', marginBottom: 8 }}>{s.label}</p>
      ...
      <div style={{ border: '1px solid var(--faint)' }}>
        ...
        {list.length === 0 && (
          <div style={{ padding: '40px 20px', textAlign: 'center' }}>
            <p style={{ fontFamily: 'var(--font-mono)', fontSize: 10, color: 'var(--muted)' }}>Nenhum membro cadastrado ainda.</p>
          </div>
        )}
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <div>
                  ...
                  {p.is_admin && (
                    <span style={{ fontFamily: 'var(--font-mono)', fontSize: 7, letterSpacing: 2, color: 'var(--gold)', textTransform: 'uppercase' }}>admin</span>
                  )}
                </div>
              </div>

              {/* Email */}
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: 10, letterSpacing: 0.5, color: 'var(--muted)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {p.email}
              </span>

              {/* Plan */}
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: 8, letterSpacing: 2, textTransform: 'uppercase', padding: '3px 10px', border: `1px solid ${p.is_subscriber ? 'var(--gold)' : 'var(--faint)'}`, color: p.is_subscriber ? 'var(--gold)' : 'var(--muted)', display: 'inline-block' }}>
                {p.plan}
              </span>
              ...
              {/* Rank */}
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: 9, letterSpacing: 1, color: 'var(--muted)' }}>
